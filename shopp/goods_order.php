<?php
	...
	switch ($a)
	{
		...
		case "order_confirm":
                ...
                $tpl -> assign('server_name',$server_name[$host]);
				$goods_order->orderConfirm($order_id, $goods, $images, $price*100, $usd_rate, $total, $channel, $channel_type);
		...
		default:
				...
				//$price_show = number_format(($price / 100), 2, ".", "");
				//$total_show = number_format(($price * $usd_rate / 100), 2, ".", "");
				$price_show =  number_format($price / $usd_rate, 2, '.', '');
				$total_show = $price;
