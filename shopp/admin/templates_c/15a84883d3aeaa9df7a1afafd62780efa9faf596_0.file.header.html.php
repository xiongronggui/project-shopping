<?php
/* Smarty version 3.1.30, created on 2018-03-26 12:24:07
  from "/u01/nginx/html/fic.sxgcsy.top/admin/templates/header.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5ab875e7123d28_29668039',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '15a84883d3aeaa9df7a1afafd62780efa9faf596' => 
    array (
      0 => '/u01/nginx/html/fic.sxgcsy.top/admin/templates/header.html',
      1 => 1521027338,
      2 => 'file',
    ),
  ),
...
function content_5ab875e7123d28_29668039 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
$__section_show_1_loop = (is_array(@$_loop=$_SESSION['admin']['action']) ? count($_loop) : max(0, (int) $_loop));
...
?>
				<li>
					...
					<ul class="submenu">
						<?php
$__section_show_son_2_saved = isset($_smarty_tpl->tpl_vars['__smarty_section_show_son']) ? $_smarty_tpl->tpl_vars['__smarty_section_show_son'] : false;
$__section_show_son_2_loop = (is_array(@$_loop=$_SESSION['admin']['action'][(isset($_smarty_tpl->tpl_vars['__smarty_section_show']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_show']->value['index'] : null)]['son']) ? count($_loop) : max(0, (int) $_loop));
$__section_show_son_2_total = $__section_show_son_2_loop;
$_smarty_tpl->tpl_vars['__smarty_section_show_son'] = new Smarty_Variable(array());
if ($__section_show_son_2_total != 0) {
for ($__section_show_son_2_iteration = 1, $_smarty_tpl->tpl_vars['__smarty_section_show_son']->value['index'] = 0; $__section_show_son_2_iteration <= $__section_show_son_2_total; $__section_show_son_2_iteration++, $_smarty_tpl->tpl_vars['__smarty_section_show_son']->value['index']++){
?>
...
if ($__section_show_son_2_saved) {
$_smarty_tpl->tpl_vars['__smarty_section_show_son'] = $__section_show_son_2_saved;
}
?>
					</ul>
				</li>
